...
// this file is all copy from SColorGradientEditor.h
...
class COLORRAMPNODE_API SCustomColorGradientEditor : public SLeafWidget
{
public:
	SLATE_BEGIN_ARGS( SCustomColorGradientEditor ) 
		: _ViewMinInput(0.0f)
		, _ViewMaxInput(0.0f)
